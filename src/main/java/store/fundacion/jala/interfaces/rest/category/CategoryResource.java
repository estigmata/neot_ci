...
package store.fundacion.jala.interfaces.rest.category;
...
import store.fundacion.jala.domain.model.category.Category;
import store.fundacion.jala.domain.model.product.Product;
import store.fundacion.jala.interfaces.rest.Paging;
import store.fundacion.jala.interfaces.rest.product.ProductRepresentation;
